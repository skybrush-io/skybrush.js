...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    '&.StatusLight-status-info': {
      ...createStyleForStatus(Status.INFO, theme),
    },
    '&.StatusLight-status-missing': {
      ...createStyleForStatus(Status.MISSING, theme, {
        glow: true,
      }),
    },
    ...
    '&.StatusLight-status-skipped': {
      ...createStyleForStatus(Status.SKIPPED, theme, {
        glow: true,
      }),
    },
    '&.StatusLight-status-success': {
      ...createStyleForStatus(Status.SUCCESS, theme),
    },
